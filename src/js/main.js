...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
    ...
    humanDiv.innerHTML = "<img src='" + imagesDatabase[humanImageChoice] + "' alt='' class='rps-image-result'>";
    botDiv.innerHTML = "<img src='" + imagesDatabase[botImageChoice] + "' alt='' class='rps-image-result'>";
